...
export const REPLENISH_BALANCE_SUCCESS = 'REPLENISH_BALANCE_SUCCESS';
...
export const FETCH_FILMS_DATA_WITH_PAGE_SUCCESS = 'FETCH_FILMS_DATA_WITH_PAGE_SUCCESS';
...
export const CAUSE_WARNING_RESET = 'CAUSE_ERROR_RESET';
